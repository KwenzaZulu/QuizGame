...
## Overview
This project is a desktop quiz application developed using **Java** and **JavaFX**.  
The application dynamically loads multiple-choice questions from a JSON file using the **Gson** library and displays them through a multi-scene user interface.
